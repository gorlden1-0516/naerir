...
# 定義輸出目錄
OUTPUT_DIR = "NAER_Academic_Data_Entry_v12"
    ...
    <div class="col-lg-9 tw-flex-1">
        ...
        <ul class="nav nav-tabs mb-4" id="adminTabs" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="rules-tab" data-bs-toggle="tab" data-bs-target="#rules" type="button" role="tab" aria-controls="rules" aria-selected="true">1. 評鑑規則設定</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="notify-tab" data-bs-toggle="tab" data-bs-target="#notify" type="button" role="tab" aria-controls="notify" aria-selected="false">2. 預警通知設定</button>
            </li>
        </ul>
...
admin_script = """
<script>
    // 解決 Tabs 無法點擊問題：手動初始化
    // 確保頁面載入後，重新綁定 Tab 事件
    document.addEventListener("DOMContentLoaded", function() {
        var triggerTabList = [].slice.call(document.querySelectorAll('#adminTabs button, #langTabs button'));
